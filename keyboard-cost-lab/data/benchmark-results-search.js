export const benchmarkResultsSearch = {
  "generatedAt": "2026-06-22T05:17:18.741Z",
  "variants": {
    "variantA": {
  ...
  "comparisons": {
    ...
    "task2_title_faq_save_options": {
      ...
      "switch": {
        "expectedReductionSeconds": 62.4,
        "expectedReductionPercent": 54.5
      }
    }
  },
  "overall": {
    "keyboard": {
      "label": "키보드 사용자",
      "variantAExpectedSeconds": 80.5,
      "variantBExpectedSeconds": 36.7,
      "expectedReductionSeconds": 43.8,
      "expectedReductionPercent": 54.4
    },
    "screenReader": {
      "label": "화면낭독 사용자",
      "variantAExpectedSeconds": 139,
      "variantBExpectedSeconds": 61.7,
      "expectedReductionSeconds": 77.3,
      "expectedReductionPercent": 55.6
    },
    "switch": {
      "label": "스위치 사용자",
      "variantAExpectedSeconds": 196.6,
      "variantBExpectedSeconds": 90.7,
      "expectedReductionSeconds": 105.9,
      "expectedReductionPercent": 53.9
    }
  },
  "measurementRules": [
