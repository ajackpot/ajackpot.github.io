export const calendarTasks = [
  {
    ...
    goalSummary: '김민아 상담사의 화요일 14:30 비대면 30분 일정을 예약하세요. 상담 주제는 ‘직장 스트레스’, 알림 방법은 ‘문자 알림’으로 선택하고 사전 작성란은 비워 두세요.',
  ...
  },
  {
    ...
    goalSummary: '기존 예약을 하나 취소한 뒤 박하늘 상담사의 목요일 10:00 대면 30분 일정을 새로 예약하세요.',
