export const calendarTasks = [
  {
    ...
    goalSummary: '김민아 상담사의 화요일 14:30 비대면 30분 슬롯을 예약하십시오.',
    instructions: [
      '서비스 유형은 상담 예약을 유지하십시오.',
      '형식을 비대면으로, 상담사를 김민아 상담사로, 시간을 30분으로 맞추십시오.',
      '화요일 오후 14:30 슬롯을 열고 예약을 확정하면 과업이 끝납니다.',
    ],
  ...
  },
  {
    ...
    goalSummary: '현재 예약을 같은 날 더 이른 13:30 슬롯으로 변경하십시오.',
    instructions: [
      '현재 예약은 유지된 상태입니다.',
      '같은 상담사, 같은 형식, 같은 길이를 유지한 채 화요일 13:30으로 변경하십시오.',
      '새 슬롯을 열고 변경을 확정하면 과업이 끝납니다.',
    ],
  ...
  },
  {
    ...
    goalSummary: '기존 예약을 취소한 뒤 박하늘 상담사의 목요일 10:00 대면 30분 슬롯을 새로 예약하십시오.',
    instructions: [
      '먼저 현재 예약을 취소하십시오.',
      '형식을 대면으로, 상담사를 박하늘 상담사로, 시간을 30분으로 맞추십시오.',
      '목요일 오전 10:00 슬롯을 열고 새 예약을 확정하면 과업이 끝납니다.',
    ],
