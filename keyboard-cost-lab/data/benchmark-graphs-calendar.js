    ...
    tasks: {
      task1_book_remote_tuesday_options: {
        ...
        steps: [
          ...
          { id: 'confirm-booking', bucket: 'recovery', navMoves: 7, activations: 2, decisions: 3, waits: 1, speechUnits: 5, contextResets: 1, scanSteps: 9 },
        ],
      },
      task2_cancel_and_rebook_thursday: {
        ...
        steps: [
          ...
          { id: 'confirm-new-booking', bucket: 'recovery', navMoves: 7, activations: 2, decisions: 3, waits: 1, speechUnits: 5, contextResets: 1, scanSteps: 9 },
        ],
      },
    },
  },
    ...
    tasks: {
      task1_book_remote_tuesday_options: {
        ...
        steps: [
          ...
          { id: 'confirm-booking', bucket: 'recovery', navMoves: 4, activations: 2, decisions: 3, waits: 1, speechUnits: 4, scanSteps: 5 },
        ],
      },
      task2_cancel_and_rebook_thursday: {
        title: '기존 예약 취소 뒤 목요일 오전 대면 예약',
        ...
        steps: [
          ...
          { id: 'confirm-new-booking', bucket: 'recovery', navMoves: 4, activations: 2, decisions: 3, waits: 1, speechUnits: 4, scanSteps: 5 },
        ],
      },
    },
  },
