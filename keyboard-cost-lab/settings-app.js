...
const STORAGE_KEY_SESSION = 'keyboard-cost-lab-settings-session-id';
...
function renderFinalView() {
  ...
  return `
    ...
    <section class="card toolbar-card">
      ...
      <div class="button-row">
        <a class="button button-secondary" download="settings-results-${escapeHtml(state.sessionId)}.json" href="${exportUrl}">결과 파일(JSON) 내려받기</a>
